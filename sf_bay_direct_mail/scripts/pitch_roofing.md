# Pitch Script — Roofing (Danville 94526)
...
> pool service, and so on. The Roofing slot for the {{Next_Drop_Month}} drop
> is open and I wanted to give {{Business_Name}} first crack at it."

## 2. The Hook (Roofing-specific)

Roof replacements happen in clusters — one neighbor sees another's new roof and the conversation starts. A postcard from the company doing two homes already on the street is the ultimate proof.

## 3. Why {{Community_Name}} for Roofing

{{Community_Name}} ({{Community_Zip}}) housing stock is heavy on 20-year-old composition shingles — right at the end of useful life. Position around free roof health checks before the rainy season.

## 4. The Offer We'd Recommend

Free roof inspection + drone photo report. $500 off any full replacement booked within 60 days. Mention financing option if you have one.

## 5. The Math (memorize this)

$650 ad. Average roof job in the Bay Area: $18K–$30K. One job covers the campaign 25× over.
...
> Roofing category for {{Community_Name}} when we finish the call and
> you put down the 50% deposit. Want me to text you my calendar link?"

## 7. If They Want to Think About It

> "Totally. Two things to know: one, I'm holding the Roofing slot for you
